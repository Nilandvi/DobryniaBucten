...
def titry():
    ...
    messages = [
        ...
        "Построить бар и стать полностью независимым от своих родственников",
        "Добрыня долго шел к своей мечте. И вот наконец, купив билет в отдаленное село",
        "Место, где о циливизации ничего и не слыхали, он решил открыть свой маленький бар..",
        f"Постройка давалась не легко. За все время Добрыня сломал {lines[20].strip()} объектов",
        ...
        "Gui Tomioka - разработчик, дизайнер, системный аналитик, архитектор",
        "KrostonKD - разработчик, креативщик",
